...
import com.example.gustavor.login.activities.MainActivity;
...
public class RecyclerViewSetUps {
    ...
    public RecyclerViewSetUps(Context mContext, RecyclerView mRecyclerView, boolean left, boolean right) {
    ...
    public void setUpItemTouchHelper() {
        ...
        ItemTouchHelper.SimpleCallback simpleItemTouchCallbackRight = new ItemTouchHelper.SimpleCallback(0, ItemTouchHelper.RIGHT) {
            ...
            private void init() {
                background = new ColorDrawable(ContextCompat.getColor(mContext, R.color.abort));
                xMark = ContextCompat.getDrawable(mContext, R.drawable.ic_clear_black_24dp);
